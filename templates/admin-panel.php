<?php
	...
	$dashboardJSONData = $defaultJSONData; //get_option('json_data', $defaultJSONData );
...
?>
	<div class="wrap">
		...
		<div class="row">
			...
			<div class="medium-9 columns">
				<button type="button" class="button right primary" onclick="javascript:rf.editQuestionnaire();"><i class="fa fa-pencil"></i> Edit Questionnaire</button>
				<button type="button" class="button right alert" onclick="javascript:rf.deleteQuestionnaire();"><i class="fa fa-trash"></i> Delete Questionnaire</button>
				<button type="button" class="button right primary" onclick="javascript:rf.createQuestionnaire();"><i class="fa fa-plus"></i> Create Questionnaire</button>
			</div>
		</div>
		
		<hr/>
		
		<div class="rf-questionnaire-container hide">
			<div class="row">
				<div class="medium-6 columns">
				
					<h4>Questions</h4>
				</div>
				<div class="medium-6 columns rf-gt-main-control-buttons">
		...
		<div class="row">
			<div class="small-12 columns">
				<form method="post" action="options.php">
					...
					<input type="hidden" name="json_data" id="rf-json-data" value="<?php echo esc_attr( $dashboardJSONData ); ?>" />
	...
	<div id="questionnaire-create-modal" class="reveal" data-reveal>
		<h2 class="title">Create New Questionnaire</h2>
		<p class="lead">Drag and drop the questions in the specific order you would like them to appear.</p>
		
		<div class="question-field">
			<label>Name
				<input type="text" name="questionnaire-name" id="questionnaire-name" />
			</label>
		</div>
		
		<div class="question-field">
			<label>Template
				<select name="questionnaire-type" id="questionnaire-type" class="widefat">
				<?php foreach (self::$Templates as $key=>$templateName) { ?>
					<option value="<?php echo $key; ?>"><?php echo $templateName; ?></option>
				<?php } ?>
				</select>
			</label>
		</div>
		
		<button class="button right" type="button" onclick="javascript: rf.createQuestionnaire(this);" data-toggle="questionnaire-create-modal"><i class="fa fa-save"></i> Submit</button>
